...
function myReplace(str, before, after) {
  /**
   * Using indexOf, toUpperCase, charAt, slice & replace
   **/
  ...
  /**
   * Intermediate: Using test, match, toUpperCase, replace & RegExp
   **/
  if ((/^[A-Z]/).test(before)) {
  ...
  /**
   * Intermediate: Using test, charAt, toUpperCase, slice, replace & RegExp
   **/
...
/**
 * Advanced: Using Math.min, split, join, toUpperCase, toLowerCase, replace & RegExp
 **/
function myReplace(str, before, after) {
...
/**
 * Advanced: Using toUpperCase, toLowerCase, capitalize, slice & RegExp
 **/
